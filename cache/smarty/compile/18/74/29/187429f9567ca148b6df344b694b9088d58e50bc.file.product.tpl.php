<?php /* Smarty version Smarty-3.1.19, created on 2017-06-06 19:25:21
         compiled from "/usr/home/spartanvape.com/web/themes/alysum/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9414466425936e58107b991-59294788%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '187429f9567ca148b6df344b694b9088d58e50bc' => 
    array (
      0 => '/usr/home/spartanvape.com/web/themes/alysum/product.tpl',
      1 => 1496768980,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9414466425936e58107b991-59294788',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5936e582372ef9_39225729',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5936e582372ef9_39225729')) {function content_5936e582372ef9_39225729($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/usr/home/spartanvape.com/web/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_cycle')) include '/usr/home/spartanvape.com/web/tools/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_function_counter')) include '/usr/home/spartanvape.com/web/tools/smarty/plugins/function.counter.php';
if (!is_callable('smarty_modifier_replace')) include '/usr/home/spartanvape.com/web/tools/smarty/plugins/modifier.replace.php';
if (!is_callable('smarty_function_math')) include '/usr/home/spartanvape.com/web/tools/smarty/plugins/function.math.php';
?>
...
')"/>
		...
		<div id="pb-right-column" class="col-xs-12 col-sm-4 col-md-5">
			...
			<div id="image-block" class="clearfix<?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)<2) {?> fwdth<?php }?>">
...
?>
						...
						<?php }?>
					<?php endfor; endif; ?>
						<span class="hidden" itemprop="ratingValue"><?php echo $_smarty_tpl->tpl_vars['productGrade']->value;?>
</span>
						<span class="hidden" itemprop="reviewCount"><?php echo $_smarty_tpl->tpl_vars['totalVotes']->value;?>
</span>
						<span class="hidden" itemprop="itemReviewed" itemscope itemtype="http://schema.org/Product"><span itemprop="name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
</span></span>
					</div>
				</div>		
			<?php }?>
...
"></div>
					        	...
					        	$(document).ready(function(){
					        		$(function() {
									    $('.countdown').countdown({
									        //date: "<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['product']->value->specificPrice['to'],'%B %e, %Y %H:%M:%S');?>
",
