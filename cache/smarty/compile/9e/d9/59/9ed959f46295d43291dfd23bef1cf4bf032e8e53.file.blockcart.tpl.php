<?php /* Smarty version Smarty-3.1.19, created on 2017-06-07 10:37:36
         compiled from "/usr/home/spartanvape.com/web/themes/alysum/modules/blockcart/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9914258465937bb50568c38-88844428%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9ed959f46295d43291dfd23bef1cf4bf032e8e53' => 
    array (
      0 => '/usr/home/spartanvape.com/web/themes/alysum/modules/blockcart/blockcart.tpl',
      1 => 1496768980,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9914258465937bb50568c38-88844428',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5937bb50ce7b27_61141379',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5937bb50ce7b27_61141379')) {function content_5937bb50ce7b27_61141379($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/usr/home/spartanvape.com/web/tools/smarty/plugins/modifier.replace.php';
if (!is_callable('smarty_function_counter')) include '/usr/home/spartanvape.com/web/tools/smarty/plugins/function.counter.php';
?><!-- MODULE Block cart -->
...
:</b>
			<span class="ajax_cart_quantity mobile_cart_num main_bg"><?php echo $_smarty_tpl->tpl_vars['cart_qties']->value;?>
</span>
...
"><img src="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],('small_').($_smarty_tpl->tpl_vars['cookie']->value->img_name));?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
											...
											<?php if (isset($_smarty_tpl->tpl_vars['product']->value['attributes_small'])&&($_smarty_tpl->tpl_vars['product']->value['attributes_small']!='')) {?>
...
"><svg class="svgic svgic-cross"><use xlink:href="#si-cross"></use></svg></a>
											<?php }?>
										</span>
...
" rel="nofollow"><svg class="svgic svgic-cross"><use xlink:href="#si-cross"></use></svg></a>
													</div>
...
:</span>
									<span id="cart_block_tax_cost" class="price ajax_cart_tax_cost lmroman"><?php echo $_smarty_tpl->tpl_vars['tax_cost']->value;?>
</span>
								</div>
							<?php }?>
...
:</span>
								<span id="cart_block_total" class="price ajax_block_cart_total lmroman main_color"><?php echo $_smarty_tpl->tpl_vars['total']->value;?>
</span>						
							</div>
						</div>
...
"><svg class="svgic svgic-cross smooth02"><use xlink:href="#si-cross"></use></svg></span>
				<h2 class="lmroman"><?php echo smartyTranslate(array('s'=>'Product successfully added to your shopping cart','mod'=>'blockcart'),$_smarty_tpl);?>
</h2>
				<br class="clearfix" />
				...
				<div class="layer_cart_product_info col-xs-12 col-md-9">
					...
					<div>
						<strong class="dark"><?php echo smartyTranslate(array('s'=>'Attributes','mod'=>'blockcart'),$_smarty_tpl);?>
:</strong>
...
&nbsp;<?php echo smartyTranslate(array('s'=>'(tax excl.)','mod'=>'blockcart'),$_smarty_tpl);?>
							...
							<span class="ajax_cart_shipping_cost price <?php if ($_smarty_tpl->tpl_vars['shipping_cost_float']->value!=0) {?>lmroman<?php }?>">
								<?php if ($_smarty_tpl->tpl_vars['shipping_cost_float']->value==0) {?>
									<?php echo smartyTranslate(array('s'=>'Free!','mod'=>'blockcart'),$_smarty_tpl);?>
