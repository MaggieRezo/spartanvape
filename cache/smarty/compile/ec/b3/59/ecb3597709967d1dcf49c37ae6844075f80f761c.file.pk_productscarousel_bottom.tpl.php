<?php /* Smarty version Smarty-3.1.19, created on 2017-06-07 10:29:05
         compiled from "/usr/home/spartanvape.com/web/modules/pk_productscarousel_bottom/pk_productscarousel_bottom.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2304319565937b951879792-10896108%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ecb3597709967d1dcf49c37ae6844075f80f761c' => 
    array (
      0 => '/usr/home/spartanvape.com/web/modules/pk_productscarousel_bottom/pk_productscarousel_bottom.tpl',
      1 => 1496768981,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2304319565937b951879792-10896108',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'add_prod_display' => 0,
    'static_token' => 0,
    'bc_products_visible' => 0,
    'bc_autoplay' => 0,
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5937b951e0abd3_19279305',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5937b951e0abd3_19279305')) {function content_5937b951e0abd3_19279305($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/usr/home/spartanvape.com/web/tools/smarty/plugins/modifier.date_format.php';
...
<div id="productsCarousel_bottom" class="carouselDesktop load-animate homemodule">
    <table class="title-table">
      <tr>
        ...
        <?php echo smartyTranslate(array('s'=>'Featured Products','mod'=>'pk_productscarousel_bottom'),$_smarty_tpl);?>

      <?php } elseif ($_smarty_tpl->tpl_vars['pr_type']->value=="new") {?>
        <?php echo smartyTranslate(array('s'=>'New Products','mod'=>'pk_productscarousel_bottom'),$_smarty_tpl);?>

      <?php } elseif ($_smarty_tpl->tpl_vars['pr_type']->value=="spe") {?>
        <?php echo smartyTranslate(array('s'=>'On Sale','mod'=>'pk_productscarousel_bottom'),$_smarty_tpl);?>

      <?php } elseif ($_smarty_tpl->tpl_vars['pr_type']->value=="bes") {?>
        <?php echo smartyTranslate(array('s'=>'Bestsellers','mod'=>'pk_productscarousel_bottom'),$_smarty_tpl);?>
...
"></div>
                              ...
                              $(document).ready(function(){
                                $(function() {
                                  $('#productsCarousel_bottom .countdown-<?php echo $_smarty_tpl->tpl_vars['set']->value['data']['id_product'];?>
').countdown({
...
");
                        ...
                        <span class="labels">
                          <?php if (isset($_smarty_tpl->tpl_vars['set']->value['data']['new'])&&$_smarty_tpl->tpl_vars['set']->value['data']['new']==1) {?><span class="pk-new sec_bg"><?php echo smartyTranslate(array('s'=>'New','mod'=>'pk_productscarousel_bottom'),$_smarty_tpl);?>
</span><?php }?>
                        ...
                        <div class="function_buttons smooth02 altview">
                          ...
                          <?php if (($_smarty_tpl->tpl_vars['wishlist']->value['install']=="installed")&&($_smarty_tpl->tpl_vars['wishlist']->value['enable']=="enabled")) {?>
                              <div class="function_button dib product_wishlist sec_bshadow_hvr smooth02 sec_bg_hvr<?php if ($_smarty_tpl->tpl_vars['isInWishList']->value[$_smarty_tpl->tpl_vars['set']->value['data']['id_product']]==1) {?> sec_bg sec_bshadow remove<?php }?>">
                                    <a href="#" class="wishlist_button addToWishlist" title="<?php if ($_smarty_tpl->tpl_vars['isInWishList']->value[$_smarty_tpl->tpl_vars['set']->value['data']['id_product']]==1) {?><?php echo smartyTranslate(array('s'=>'This product is already in your wishlist','mod'=>'pk_productscarousel_bottom'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Add to Wishlist','mod'=>'pk_productscarousel_bottom'),$_smarty_tpl);?>
<?php }?>">
                              ...
                              <?php if (($_smarty_tpl->tpl_vars['favorite']->value['install']=="installed")&&($_smarty_tpl->tpl_vars['favorite']->value['enable']=="enabled")) {?>
                                <div class="function_button dib product_like sec_bshadow_hvr smooth02 sec_bg_hvr <?php if ($_smarty_tpl->tpl_vars['isFav']->value[$_smarty_tpl->tpl_vars['set']->value['data']['id_product']]==1) {?> sec_bg sec_bshadow<?php }?>">
                                  <a title="<?php echo smartyTranslate(array('s'=>'Add this product to my favorites','mod'=>'pk_productscarousel_bottom'),$_smarty_tpl);?>
" href="#" class="addfav dib<?php if ($_smarty_tpl->tpl_vars['isFav']->value[$_smarty_tpl->tpl_vars['set']->value['data']['id_product']]==1) {?> hidden<?php }?>">
                                  ...
                                  <a title="<?php echo smartyTranslate(array('s'=>'Remove product from my favorites','mod'=>'pk_productscarousel_bottom'),$_smarty_tpl);?>
...
"  href="#" class="remfav sec_bg_hvr dib button<?php if ($_smarty_tpl->tpl_vars['isFav']->value[$_smarty_tpl->tpl_vars['set']->value['data']['id_product']]!=1) {?> hidden<?php }?>"><svg class="svgic svgic-like"><use xlink:href="#si-like"></use></svg></a>
                          ...
                          <a href="#" class="wishlist_button sec_bg_hvr dib button addToWishlist" onclick="WishlistCart('wishlist_block_list', 'add', '<?php echo intval($_smarty_tpl->tpl_vars['set']->value['data']['id_product']);?>
...
" title="<?php if ($_smarty_tpl->tpl_vars['isInWishList']->value[$_smarty_tpl->tpl_vars['set']->value['data']['id_product']]==1) {?><?php echo smartyTranslate(array('s'=>'This product is already in your wishlist','mod'=>'pk_productscarousel_bottom'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Add to Wishlist','mod'=>'pk_productscarousel_bottom'),$_smarty_tpl);?>
...
" class="button exclusive dib"><?php echo smartyTranslate(array('s'=>'View','mod'=>'pk_productscarousel_bottom'),$_smarty_tpl);?>
</a><?php }?><?php } else { ?><a href="<?php echo $_smarty_tpl->tpl_vars['set']->value['data']['link'];?>
" class="button exclusive dib"><?php echo smartyTranslate(array('s'=>'Details','mod'=>'pk_productscarousel_bottom'),$_smarty_tpl);?>
</a><?php }?><?php if (($_smarty_tpl->tpl_vars['favorite']->value['install']=="installed")&&($_smarty_tpl->tpl_vars['favorite']->value['enable']=="enabled")) {?><div class="function_button normview product_like<?php if ($_smarty_tpl->tpl_vars['isFav']->value[$_smarty_tpl->tpl_vars['set']->value['data']['id_product']]==1) {?> active<?php }?>"><a title="<?php echo smartyTranslate(array('s'=>'Add this product to my favorites','mod'=>'pk_productscarousel_bottom'),$_smarty_tpl);?>
...
<?php }?>"><svg class="svgic svgic-wishlist"><use xlink:href="#si-wishlist"></use></svg></a>
        ...
        <?php } else { ?>
          <p class="alert alert-warning"><?php echo smartyTranslate(array('s'=>'There are no products right now','mod'=>'pk_productscarousel_bottom'),$_smarty_tpl);?>
</p>
        <?php }?>
...
<?php $_smarty_tpl->smarty->_tag_stack[] = array('addJsDefL', array('name'=>'favadd')); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['addJsDefL'][0][0]->addJsDefL(array('name'=>'favadd'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
<?php echo smartyTranslate(array('s'=>'has been added to your favorites','mod'=>'pk_productscarousel_bottom','js'=>1),$_smarty_tpl);?>
...
<?php echo smartyTranslate(array('s'=>'has been removed from your favorites','mod'=>'pk_productscarousel_bottom','js'=>1),$_smarty_tpl);?>
...
$(document).ready(function() {
      $("#products-bottom").flexisel({
            pref: "btm",
            visibleItems: <?php if (isset($_smarty_tpl->tpl_vars['bc_products_visible']->value)) {?><?php echo $_smarty_tpl->tpl_vars['bc_products_visible']->value;?>
<?php } else { ?>5<?php }?>,
            animationSpeed: 500,
            autoPlay: <?php if (isset($_smarty_tpl->tpl_vars['bc_autoplay']->value)&&$_smarty_tpl->tpl_vars['bc_autoplay']->value==1) {?>true<?php } else { ?>false<?php }?>,
            autoPlaySpeed: 3000,            
            pauseOnHover: true,
