...
<script type="text/javascript">
        jQuery(function(){         
            jQuery('#camera_wrap').camera({
                ...
                slicedCols: {if $minicSlider.options.slices != ''}{$minicSlider.options.slices}{else}3{/if},
                slicedRows: {if $minicSlider.options.rows != ''}{$minicSlider.options.rows}{else}3{/if}, 
