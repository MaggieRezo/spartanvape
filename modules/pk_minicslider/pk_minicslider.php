...
class pk_minicslider extends Module
{
	...
	private function insertOptions()
		{
			...
			if (!Db::getInstance()->Execute("
			INSERT INTO `"._DB_PREFIX_."minic_slider_nivo` (`id_shop`, `id_lang`, `id_order`, `lang_iso`, `title`, `url`, `target`, `image`, `alt`, `caption`, `active`) VALUES	(".$id_shop.", 1, 1, 'en', 'new arrivals', '#', 0, 'mslide01.jpg', '', '<h2 class=\'main_color\'>Colorize</h2>\r\n<h3 class=\'main_color\'>your style</h3>\r\n<span>Quisque volutpat blandit ipsum eget pulvinar. In viverra,<br/> mi ac convallis dictum enim. condimentum lorem. </span><br/><br/><a href=\'#\' class=\'button sec_bord_hvr sec_bg_hvr\'>shop now</a>', 1), (".$id_shop.", 1, 2, 'en', 'ladies', '#', 0, 'mslide02.jpg', '', '<h2 class=\'main_color\'>Spring</h2>\r\n<h3 class=\'main_color\'>essentials</h3>\r\n<span>Quisque volutpat blandit ipsum eget pulvinar. In viverra,<br/> mi ac convallis dictum enim. condimentum lorem.</span>', 1), (".$id_shop.", 1, 3, 'en', 'newsletter', '#', 0, 'mslide03.jpg', '', '<h2 class=\'main_color\'>sign up</h2>\r\n<h3 class=\'main_color\'>and get 25% off</h3>\r\n<span>Aliquam quam mauris, commodo eget pretium dignissim, porta ac<br/>purus. Nulla non porttitor quam. Phasellus eu mattis erat.</span>', 1);")){
				return false;
			}
			return true;
		}
	...
	public function hookDisplayHeader() {
		...
		//$this->context->controller->addJS($this->_path.'views/js/unslider.min.js');
