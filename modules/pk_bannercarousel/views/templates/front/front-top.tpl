            ...
            $(window).load(function() {
              var v_num = {$minicSlider.options.startSlide};
                 $(".sliderCarousel_top").flexisel({
                      ...
                      autoPlay: {if $minicSlider.options.manual != ''}{$minicSlider.options.manual}{else}false{/if},
                      autoPlaySpeed: {if $minicSlider.options.pause != ''}{$minicSlider.options.pause}{else}3000{/if},
                      pauseOnHover: {if $minicSlider.options.hover != ''}{$minicSlider.options.hover}{else}true{/if},
