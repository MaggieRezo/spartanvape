<div id="sequence-theme" class="load-animate homemodule">
    ...
    <div id="sequence">
        <ul>
            ...
            <li class="animate-in" id="slide{$slide.id_slide}" data-id="{$slide.id_slide}" data-info="shop{$image.id_shop}langiso{$image.lang_iso}">                          
                ...
                <div class="slide-text">
                    ...
                    {/if}
                    <div id="htmlcaption_{$slide.id_slide}" class="slide-text-{$slide.id_slide} slide-content">
                        <h3 class="trajan">{$slide.title}</h3>
                        <p>{$slide.caption}</p>
