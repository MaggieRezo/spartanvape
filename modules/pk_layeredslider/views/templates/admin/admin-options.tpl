...
<fieldset id="option" class="hidden-div">
	<legend>{l s='Options' mod='pk_layeredslider'}</legend>
	<form id="slider_options" method="post" action="{$slider.postAction}">
		<div id="options" class="container">
            ...
            <div class="configuration">
                <h3>{l s='Animation Configuration' mod='pk_layeredslider'}</h3>
                <!--<div>
                ...
                <div>
                    <label>{l s='Pause Time' mod='pk_layeredslider'}: </label>
					<input type="text" name="pause" value="{$slider.options.pause}" class="tooltip2" title="{l s='How long each slide will be shown in miliseconds (default is 3 sec)' mod='pk_layeredslider'}">
                </div>
                <div class="switch">
                    <label>{l s='Pause on Mouse Hover' mod='pk_layeredslider'}: </label>
					...
					<span class="info_ico tooltip2" title="{l s='Pause the slider on mouse hover.' mod='pk_layeredslider'}"></span>
                </div>
                <div class="switch">
                    <label>{l s='Auto Rotate' mod='pk_layeredslider'}: </label>
					<div class="field switch">
					...
					<span class="info_ico tooltip2" title="{l s='Turn it OFF if you dont want the slider to auto slide.' mod='pk_layeredslider'}"></span>
                </div>                    
            </div>
            <div class="navigation">
                <h3>{l s='Navigation' mod='pk_layeredslider'}</h3>
                <div class="switch">
                    <label>{l s='Prev/Next button' mod='pk_layeredslider'}: </label>
					<div class="field switch">
					...
					<span class="info_ico tooltip2" title="{l s='If you want previous and next buttons on the two side of the slider, then turn this on.' mod='pk_layeredslider'}"></span>
                </div>
                <div class="switch">
                    <label>{l s='Control' mod='pk_layeredslider'}: </label>
					<div class="field switch">
					...
					<span class="info_ico tooltip2" title="{l s='This controls the navigation, by default these are the litle dots under the slider.' mod='pk_layeredslider'}"></span>
                </div>
               <!-- <div class="switch">
            ...
            <div class="other">
                <h3>{l s='Other' mod='pk_layeredslider'}</h3>
                <!--<div class="switch">
                ...
                <div class="switch">
                    <label>{l s='I need multilanguage' mod='pk_layeredslider'}: </label>
					<div class="field switch">
					...
					<span class="info_ico tooltip2" title="{l s='Turn on if you want to use different slides for different languages, otherwise the default language slides will be used for all the languages.' mod='pk_layeredslider'}"></span>
                </div>       
                <!--<div>
            ...
            <div class="button_cont">
				<input type="submit" name="submitOptions" value="{l s='Update' mod='pk_layeredslider'}" id="submitOptions" class="green large" />
			</div>
		</div>
	</form>
</fieldset>